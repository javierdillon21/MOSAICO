...
export default function Header() {
  ...
  return (
    <header className="flex absolute md:static xl:absolute z-10 text-third h-20 max-h-20 w-screen ">
      <div
        id="navegacion"
        className="flex invisible px-8 gap-16 w-screen bg-white items-center justify-between md:text-lg lg:text-xl  text-third font-title md:visible md:h-navegationbar"
      >
